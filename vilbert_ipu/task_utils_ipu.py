...
class VILBertForVLTasksWithLoss(VILBertForVLTasks):
    def __init__(self, config, num_labels, losses, dropout_prob=0.1) -> None:
        super().__init__(config, num_labels, dropout_prob=0.1)
        self.losses = losses

class BaseBertForVLTasksWithLoss(BaseBertForVLTasks):
    def __init__(self, config, num_labels, losses, dropout_prob=0.1) -> None:
        super().__init__(config, num_labels, dropout_prob=0.1)
        self.losses = losses

# def BuilModelWithLosses(args, task_cfg,):
